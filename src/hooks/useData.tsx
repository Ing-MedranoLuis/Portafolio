...
export const useData = () => {
    ...
    const images: string[] = [`src/img/Screenshot 2025-12-21 175547.png`, 'src/img/Screenshot 2025-12-21 175601.png', 'src/img/Screenshot 2025-12-21 175615.png', 'src/img/Screenshot 2024-05-26 211211.png'];
