    ...
    >
      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto">
        ...
        <motion.h1
          ...
          className="font-body text-5xl md:text-7xl lg:text-8xl font-medium leading-tight mb-8"
        >
          Crafting Digital
          <br />
        ...
        >
          <motion.a
            ...
            whileTap={{ scale: 0.98 }}
            className="px-8 py-4 bg-primary text-primary-foreground rounded-full font-medium transition-shadow duration-300 hover:shadow-lg hover:shadow-primary/25"
          >
            View My Work
          </motion.a>
          <motion.a
            ...
            whileHover={{ scale: 1.02, y: -2 }}
            whileTap={{ scale: 0.98 }}
            className="px-8 py-4 border border-border text-foreground rounded-full font-medium transition-colors duration-300 hover:bg-secondary hover:border-muted"
          >
            About Me
          </motion.a>
        </motion.div>
